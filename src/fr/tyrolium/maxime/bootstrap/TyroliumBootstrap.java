package fr.tyrolium.maxime.bootstrap;
...
public class TyroliumBootstrap {
	...
	private static final File TY_DIR = GameDir.createGameDir("Tyrolium");
	...
	public static void main(String[] args) {
		...
		setResourcePath("/fr/tyrolium/maxime/bootstrap/resources");
		displaySplash();
		try {
			doUpdate();
		} catch (Exception e) {
	...
	private static void doUpdate() throws Exception{
		...
		SUpdate su = new SUpdate("http://tyrolium.fr/Contenu/Bootstrap", new File(TY_DIR, "Launcher"));
